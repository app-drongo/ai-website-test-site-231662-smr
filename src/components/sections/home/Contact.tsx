...
const DEFAULT_CONTACT = {
  badge: 'Get In Touch',
  mainTitle: 'Ready to Get',
  mainTitleHighlight: 'Started?',
  mainDescription:
    "We're here to help you succeed. Drop us a message and we'll get back to you within 24 hours with personalized solutions for your needs.",
  formTitle: 'Send us a Message',
  formDescription: "Tell us about your project and we'll provide you with a custom solution.",
  submitButton: 'Send Message',
  contactSectionTitle: 'Contact Methods',
  method1Title: 'Email Support',
  method1Description: 'Quick response guaranteed',
  method1Contact: 'hello@testsite.com',
  method2Title: 'Phone Support',
  method2Description: 'Speak directly with our team',
  method2Contact: '+1 (555) 987-6543',
  method3Title: 'Live Chat',
  method3Description: 'Instant help when you need it',
  method3Contact: 'Available 9 AM - 6 PM EST',
  officesSectionTitle: 'Our Locations',
  office1City: 'Austin',
  office1Address: '2100 Innovation Blvd, Suite 200',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Denver',
  office2Address: '1500 Market Street, Floor 12',
  office2Timezone: 'MST (UTC-7)',
  office3City: 'Seattle',
  office3Address: '800 Pine Street, Building C',
  office3Timezone: 'PST (UTC-8)',
  hoursTitle: 'Business Hours',
  hoursWeekdayLabel: 'Monday - Friday',
  hoursWeekdayTime: '9:00 AM - 6:00 PM',
  hoursSaturdayLabel: 'Saturday',
  hoursSaturdayTime: '10:00 AM - 2:00 PM',
  hoursSundayLabel: 'Sunday',
  hoursSundayTime: 'Closed',
  supportNote: 'Priority support available for premium customers',
  nameLabel: 'Full Name *',
  ...
  messagePlaceholder: 'Describe your project, goals, and how we can help you achieve them...',
} as const;
