...
const DEFAULT_HERO = {
  badge: 'Beta Testing Available',
  title: 'Test your ideas with confidence using',
  titleHighlight: 'proven validation methods',
  description:
    'Transform your concepts into market-ready solutions with our comprehensive testing platform. Get real user feedback, validate assumptions, and launch with certainty.',
  features: [
  ...
  statsValue1: '94% validated',
  statsLabel2: 'Time Saved',
  statsValue2: '60% faster',
} as const;
